...
public class Base
{
    ...
    public Unit AcquireRandomUnit() => _barrack.AcquireRandomUnit();
    ...
    public Troop CreateTroop(int attackUnitsCount, int defenceUnitsCount, int speedUnitsCount)
    {
        ...
        {
            unitList.Add(_barrack.AcquireUnit(UnitType.attackUnit));
        }

        for (int i = 0; i < defenceUnitsCount; i++)
        {
            unitList.Add(_barrack.AcquireUnit(UnitType.defenceUnit));
        }

        for (int i = 0; i < speedUnitsCount; i++)
        {
            unitList.Add(_barrack.AcquireUnit(UnitType.speedUnit));
        }
